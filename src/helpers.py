...
def get_bar_plot(display_data, color_col_name: str, title: str):
    """
    Generate a bar plot using Plotly.

    Parameters:
    display_data (DataFrame): The data to be plotted, containing columns 'launch_year' and 'launch_count'.
    color_col_name (str): The column name to be used for coloring the bars.
    title (str): The title of the plot.

    Returns:
    Figure: A Plotly Figure object representing the bar plot.
    """
...
def get_line_plot(display_data, x_col: str, y_col: str, labels: dict, color_sequence: list[str], title: str, color_col: str = None):
    """
    ...
    Returns:
    Figure: A Plotly Figure object representing the line plot.
    """
    fig = px.line(
        display_data,
        x=x_col,
...
def display_plot(fig, png_path: str = None, html_path: str = None):
    """
    Display and optionally save a Plotly figure.

    Parameters:
    fig (Figure): The Plotly figure to be displayed and saved.
